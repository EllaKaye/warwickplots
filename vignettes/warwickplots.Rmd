...
If the paths in the tibble show Lato and Avenir Next, then they are installed on your system. If they show another font, i.e. your system default, then they are not. For example, if I ask for a font I don't have installed, I see that my system will default to using Helvetica: 

```{r}
systemfonts::match_fonts("non-existent-font")
```
